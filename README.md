...
```javascript
import smskrange from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-smskrange@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-smskrange/tags). For example,

```javascript
import smskrange from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-smskrange@v0.1.1-deno/mod.js';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-smskrange.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-smskrange

[test-image]: https://github.com/stdlib-js/stats-strided-smskrange/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-smskrange/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-smskrange/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-smskrange?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-smskrange.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-smskrange/main
...
[branches-url]: https://github.com/stdlib-js/stats-strided-smskrange/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-smskrange/main/LICENSE
